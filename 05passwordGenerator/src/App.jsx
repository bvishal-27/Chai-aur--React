import { useCallback, useState  ,useEffect,useRf} from 'react'
...
useEffect(()=>{
  ...
  return (
    <>
    <div className='w-full max-w-md mx-w-md mx-auto shadow-md
    rounded-lg  px-4 my-8 text-orange-500 bg-gray-700'>
      <h1 className='text-white text-center my-10 mx-5'>Password generator</h1>
